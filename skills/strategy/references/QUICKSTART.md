...
> **Get from zero to orchestrated multi-team pipeline in 5 minutes.**

---

## What is NEXUS?

**NEXUS** (Network of EXperts, Unified in Strategy) turns The Agency's AI specialists into a coordinated pipeline. Instead of activating teams one at a time and hoping they work together, NEXUS defines exactly who does what, when, and how quality is verified at every step.

## Choose Your Mode

| I want to... | Use | Teams | Time |
|-------------|-----|--------|------|
...
```
Activate Strategy Team Orchestrator in NEXUS-Full mode.
...
- Phase 5: Launch (Growth Hacker, Content Creator, all marketing teams, DevOps Automator)
...
```
Activate Strategy Team Orchestrator in NEXUS-Sprint mode.
...
| **Activation Prompts** | Ready-to-use team prompts | `strategy/coordination/team-activation-prompts.md` |
...
3. **Handoffs** — Structured context transfer between teams (never start cold)
4. **Reality Checker** — Final quality authority; defaults to "NEEDS WORK"
5. **Strategy Team Orchestrator** — Pipeline controller managing the entire flow
...
Support Responder   │ XR Interface Arch.  │ Strategy Team Orchestrator
