...
> Standardized templates for every type of team-to-team handoff in the NEXUS pipeline. Consistent handoffs prevent context loss — the #1 cause of multi-team coordination failure.

---

## 1. Standard Handoff Template

Use for any team-to-team work transfer.
...
Use when Evidence Collector or other QA team approves a task.
...
## Next Action
→ Strategy Team Orchestrator: Mark task complete, advance to next task in backlog
```
...
Use when Evidence Collector or other QA team rejects a task.
...
**If attempt 3 fails**: Task will be escalated to Strategy Team Orchestrator
```
...
| **Escalation To** | [Strategy Team Orchestrator / Studio Producer] |
| **Timestamp** | [YYYY-MM-DDTHH:MM:SSZ] |
...
- [ ] **Reassign** to different developer team ([recommended team])
...
## Decision Required
**Decision maker**: [Strategy Team Orchestrator / Studio Producer]
...
## Team Activation for Next Phase
| Team | Role | Priority |
|-------|------|----------|
| [Team 1] | [Role in next phase] | [Immediate / Day 2 / As needed] |
| [Team 2] | [Role in next phase] | [Immediate / Day 2 / As needed] |

## Risks Carried Forward
| Risk | Severity | Mitigation | Owner |
|------|----------|------------|-------|
| [Risk] | [P0-P3] | [Mitigation plan] | [Team] |
```
...
|-----------|----------------|
| Assigning work to another team | Standard Handoff (#1) |
