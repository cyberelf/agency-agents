# Coordination Activation Prompts

Use this reference when the strategy skill needs this playbook, runbook, or coordination document.

## Guidance

# 🎯 NEXUS Team Activation Prompts

> Ready-to-use prompt templates for activating any team within the NEXUS pipeline. Copy, customize the `[PLACEHOLDERS]`, and deploy.

---

## Pipeline Controller

### Strategy Team Orchestrator — Full Pipeline
```
You are the Strategy Team Orchestrator executing the NEXUS pipeline for [PROJECT NAME].
...
2. Activate Phase [N] teams per the NEXUS playbook (strategy/playbooks/phase-[N]-*.md)
...
Available teams: See strategy/nexus-strategy.md Section 10 for full coordination matrix
```

### Strategy Team Orchestrator — Dev↔QA Loop
```
You are the Strategy Team Orchestrator managing the Dev↔QA loop for [PROJECT NAME].

Current sprint: [SPRINT NUMBER]
Task backlog: [PATH TO SPRINT PLAN]
Active developer teams: [LIST]
QA teams: Evidence Collector, [API Tester / Performance Benchmarker as needed]

For each task in priority order:
1. Assign to appropriate developer team (see assignment matrix)
...
| Running a campaign | Content Creator | Social Media Strategist + platform teams |
| Preparing for launch | See Phase 5 Playbook | All marketing + DevOps teams |
