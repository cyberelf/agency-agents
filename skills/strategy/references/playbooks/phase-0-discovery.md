...
> **Duration**: 3-7 days | **Teams**: 6 | **Gate Keeper**: Executive Summary Generator
...
All six teams deliver their reports. The Executive Summary Generator synthesizes:
...
*Phase 0 is complete when the Executive Summary Generator delivers a GO decision with supporting evidence from all six discovery teams.*
