...
> **Duration**: Ongoing | **Teams**: 12+ (rotating) | **Governance**: Studio Producer
...
2. Appropriate Developer Team implements
...
| **P2 — Medium** | Minor feature issue, workaround available | < 4 hours | Strategy Team Orchestrator |
...
DETECTION (Infrastructure Maintainer or Support Responder)
    │
    ▼
TRIAGE (Strategy Team Orchestrator)
...
RESPONSE
    ...
    ├── P1: Relevant Developer Team + DevOps Automator
    ├── P2: Relevant Developer Team
