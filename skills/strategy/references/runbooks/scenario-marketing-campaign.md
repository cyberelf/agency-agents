...
> **Mode**: NEXUS-Micro to NEXUS-Sprint | **Duration**: 2-4 weeks | **Teams**: 10-15
...
```
Daily:
├── Platform teams → Engagement and content posting
...
| Engagement rate | > 3% average across platforms | Platform teams |
...
| Platform | Primary KPI | Secondary KPI | Team |
|----------|------------|---------------|-------|
