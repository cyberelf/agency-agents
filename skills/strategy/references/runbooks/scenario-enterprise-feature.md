...
> **Mode**: NEXUS-Sprint | **Duration**: 6-12 weeks | **Teams**: 20-30
...
```
Sprint 1-3 (Week 4-9):
├── Strategy Team Orchestrator → Dev↔QA loop management
...
| Audience | Frequency | Team | Format |
|----------|-----------|-------|--------|
...
| Engineering team | Daily | Strategy Team Orchestrator | Pipeline status |
