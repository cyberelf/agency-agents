...
> **Mode**: NEXUS-Micro | **Duration**: Minutes to hours | **Teams**: 3-8
...
| **Relevant Developer Team** | Fix implementation |
...
```
TRIGGER: Alert from monitoring / User report / Team detection
...
IF caused by code bug:
  → Relevant Developer Team: Implement hotfix
  → Evidence Collector: Verify fix
